                    ...
                    <div className="lg:col-span-4 space-y-8">
                        ...
                        <div className="bg-slate-50 p-8 rounded-3xl border border-slate-100">
                            ...
                            <div className="space-y-4">
                                <a href="tel:18001234567" className="flex items-center gap-3 p-4 bg-white rounded-2xl border border-slate-200 group hover:border-blue-900 transition">
                                    <i className="fas fa-phone-alt text-blue-600 group-hover:text-blue-900"></i>
                                    <span className="font-bold text-slate-800">1800-123-4567</span>
                                </a>
                            </div>
                        </div>
                    </div>
