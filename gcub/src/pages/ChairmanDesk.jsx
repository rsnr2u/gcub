...
const ChairmanDesk = () => {
    ...
    useEffect(() => {
        const fetchChairman = async () => {
            try {
                const response = await fetch('http://localhost:8080/api/chairman');
                            ...
                            <div className="w-full lg:w-1/3 sticky top-24">
                                <div className="bg-white border border-gray-100 shadow-sm overflow-hidden p-2 rounded-lg">
                                    <div className="aspect-[4/5] overflow-hidden bg-gray-50 mb-6">
                                        <img
                                            src={chairman.image_path ? `http://localhost:8080/${chairman.image_path}` : "/assets/images/management/default.png"}
                                            alt={chairman.name}
