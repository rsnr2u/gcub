    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (result.status === 'success') {
                ...
                setTimeout(() => navigate('/admin/board-management'), 1200);
            } else {
        ...
        <div className="font-inter min-h-screen">
            <header className="max-w-4xl mx-auto flex px-8 py-2 justify-between items-center">
                <div className="flex items-center gap-4">
                    <Link to="/admin/board-management" className="text-gray-400 hover:text-[#003399] transition">
                        <i className="fas fa-arrow-left"></i>
                    </Link>
                    <div>
                        <h2 className="text-xl font-bold text-gray-800">{isEdit ? 'Edit Member' : 'New Member'}</h2>
                        <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-0.5">Management Profile</p>
                    </div>
                </div>
            </header>
                ...
                <form onSubmit={handleSubmit} className="bg-white border border-gray-100 rounded-xl shadow-sm p-10 space-y-8">
                    ...
                    <div className="pt-8 border-t border-gray-100">
                        ...
                        >
                            ...
                            {saving ? 'Processing...' : 'Save Member Profile'}
                        </button>
                    </div>
                </form>
            </div>
...
export default AdminEditBoardManagement;
