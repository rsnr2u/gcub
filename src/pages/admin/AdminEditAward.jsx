...
const AdminEditAward = () => {
    ...
    const fetchAward = async () => {
        try {
            const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/awards/show/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        const url = isEdit
            ? `${import.meta.env.VITE_API_BASE_URL}/awards/update/${id}`
            : `${import.meta.env.VITE_API_BASE_URL}/awards/create`;
